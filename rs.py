...
class ray:
	...
	def __init__(self,heading=np.array([0.0,0.0,0.0]),position=np.array([0.0,0.0,0.0]),target=np.array([0.0,0.0,0.0])):
...
if __name__ == '__main__':
	...
	# test ray
	ra1 = ray(heading=np.array([1,1,1]),position=np.array([0,0,0]),target=np.array([2,2,2]))
